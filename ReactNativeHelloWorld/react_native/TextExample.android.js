...
var UIExplorerBlock = require('../react_native/UIExplorerBlock');
var UIExplorerPage = require('../react_native/UIExplorerPage');
    ...
    return (
      <UIExplorerPage title="<Text>">
        ...
        <UIExplorerBlock title="Inline images">
          <Text>
            This text contains an inline image <Image source={require('../images/flux.png')}/>. Neat, huh?
          </Text>
        </UIExplorerBlock>
